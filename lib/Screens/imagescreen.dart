...
import 'package:pichunt/Api/apimodel.dart';
import 'package:pichunt/Constants/constants.dart';
import 'package:pichunt/Provider/favorite.dart';
...
class _ImageScreenState extends State<ImageScreen> {
  ...
  Future<void> _downloadImage() async {
    try {
      ...
      final folderName =
          'PicHunt'; // Replace 'YourFolderName' with your desired folder name
